...
export const generateRegistrationPDF = async (data: PatientData) => {
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; background: white; margin: 0; page-break-after: avoid;">
      <!-- Header -->
      ...
      <div style="border-left: 4px solid #dc2626; padding-left: 15px; margin-bottom: 20px; page-break-inside: avoid;">
      ...
      <div style="border-left: 4px solid #0284c7; padding-left: 15px; margin-bottom: 20px; page-break-inside: avoid;">
      ...
      <div style="border-left: 4px solid #16a34a; padding-left: 15px; margin-bottom: 20px; page-break-inside: avoid;">
      ...
      <!-- Footer -->
      <div style="border-top: 2px solid #e5e7eb; padding-top: 15px; margin-top: 30px; font-size: 10px; color: #6b7280; text-align: center; page-break-inside: avoid;">
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `Registration_${data.caseId}.pdf`);
  } finally {
...
export const generateTriagePDF = async (data: PatientData) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; background: white; margin: 0; page-break-after: avoid;">
      ...
      <!-- Patient Status -->
      <div style="border-left: 4px solid #7c3aed; padding-left: 15px; margin-bottom: 20px; page-break-inside: avoid;">
      ...
      <!-- Risk Alerts -->
      <div style="background: #fef2f2; border: 2px solid #dc2626; border-left: 4px solid #dc2626; padding: 15px; margin-bottom: 20px; border-radius: 4px; page-break-inside: avoid;">
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `Triage_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
...
export const generateMedicalHistoryPDF = async (data: PatientData) => {
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; background: white; margin: 0; page-break-after: avoid;">
      ...
      <!-- Lifestyle -->
      <div style="border-left: 4px solid #ea580c; padding-left: 15px; margin-bottom: 20px; page-break-inside: avoid;">
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `MedicalHistory_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
...
export const generateAllergyMedsPDF = async (data: PatientData) => {
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 800px; background: white; margin: 0; page-break-after: avoid;">
      ...
      <!-- Allergies Section -->
      <div style="background: #fef2f2; border: 3px solid #dc2626; border-radius: 8px; padding: 15px; margin-bottom: 20px; page-break-inside: avoid;">
        ...
        <div style="background: white; padding: 10px; border-radius: 4px; margin: 8px 0; min-height: 40px; border: 1px solid #fca5a5; font-size: 12px;">
      ...
      <div style="border-left: 4px solid #0284c7; padding-left: 15px; margin-bottom: 20px; page-break-inside: avoid;">
        ...
        <div style="background: #f0f9ff; padding: 10px; border-radius: 4px; margin: 8px 0; min-height: 40px; border: 1px solid #bfdbfe; font-size: 12px;">
      ...
      <!-- AI Risk Assessment -->
      <div style="background: #fef3c7; border: 2px solid #ea580c; border-left: 4px solid #ea580c; padding: 15px; margin-bottom: 20px; border-radius: 4px; page-break-inside: avoid;">
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `AllergyMeds_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
...
export const generateVitalSignsPDF = async (data: PatientData) => {
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `VitalSigns_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
...
export const generateCategoryFormPDF = async (data: PatientData) => {
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `CategoryForm_${data.category}_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
...
export const generateDoctorSummaryPDF = async (data: PatientData) => {
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `DoctorSummary_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
...
export const generateConsentFormPDF = async (data: PatientData) => {
  ...
  try {
    await generatePDFFromHTML(div.firstElementChild as HTMLElement, `ConsentForm_${data.caseId}.pdf`);
  } finally {
    document.body.removeChild(div);
  }
};
